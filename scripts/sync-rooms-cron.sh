...
#
# This script is meant to be run by cron to sync rooms daily.
# Example cron entry (runs at 1:30 AM daily):
#   30 1 * * * cd /path/to/inventory-service && ./scripts/sync-rooms-cron.sh
#
...
echo "🔄 Starting daily inventory-service room sync cron job..."
node "$SCRIPT_DIR/sync-rooms-cron.js"
